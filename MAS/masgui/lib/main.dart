  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) async {
        ...
        // 加载保存的服务器配置
        final savedServerMode = prefs!.getString('serverMode');
        if (savedServerMode != null) {
          AppConfig.serverMode = savedServerMode;
        }

        final savedMultiAgentServer = prefs!.getString('multiAgentServer');
        if (savedMultiAgentServer != null) {
          AppConfig.multiAgentServer = savedMultiAgentServer;
        }
                ...
                if (AppConfig.serverMode == 'multiagent')
                  IconButton(
                    icon: Icon(
                      ...
                      color:
                          useRAG ? Theme.of(context).colorScheme.primary : null,
                    ),
